...
<title>Exploring Wines in Name</title>
</head>
...
<?php
  ...
  // Show all wines in a wine in a <table>
  ...
  // Start a query ...
  $query = "SELECT wine_id, wine_name, description, year
FROM winery, region, wine
WHERE winery.region_id = region.region_id
AND wine.winery_id = winery.winery_id";

  // ... then, if the user has specified a wine, add the wineName
  // as an AND clause ...
